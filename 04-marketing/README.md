# 04 — Marketing & Go-To-Market Module

Everything needed to bring the AI-integration coaching practice to market: build an audience, generate leads, and land the first clients — grounded in Alex Hormozi's offer/lead principles and other proven operators, and **modular** so the whole engine can be re-aimed at a different niche with one prompt.

## Map

| File | What it is | Use it when |
|---|---|---|
| `M1-principles-library.md` | The reusable principle blocks (Hormozi, Dunford, StoryBrand, Godin, Enns, Stark, Weiss…), each with ID + apply-when | Designing/reviewing ANY offer, funnel or campaign |
...
## How the pieces connect (the funnel)
      ...
      20-min debrief / reaction call (free, diagnostic)
                     │  reactions → seed client-context.md (Prompt P-C)
                              ...
                              Discovery call (assets/discovery-call)
                                           │
                                           ▼
                        AI Kickstart (Grand Slam Offer, M2) — SME track
                                           │
                                           ▼
                        Retainer / full 7-phase engagement (corporate track)
```
